...
void loop()
{
  ...
  String s = "";
  s += accel_t_gyro.value.x_accel;
  s += ",";
  s += accel_t_gyro.value.y_accel;
  s += ",";
  s += accel_t_gyro.value.z_accel;
  s += ",";
  s += accel_t_gyro.value.x_gyro;
  s += ",";
  s += accel_t_gyro.value.y_gyro;
  s += ",";
  s += accel_t_gyro.value.z_gyro;
  Serial.println(s);
